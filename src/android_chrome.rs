...
/// # Examples
/// ```text
/// uws android-management --params '{"name":"enterprises/acme/devices"}' --path /enterprises/acme/devices
/// uws chrome-management --path /customers/acme/reports/printUsage --dry-run
/// ```
